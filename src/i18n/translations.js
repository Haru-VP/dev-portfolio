export const translations = {
  es: {
    ...
    /* ===== FEATURED ===== */
    featuredTitle: "Lo que hago",
    featuredSubtitle:
      "Me enfoco en crear productos digitales cuidados, accesibles y con propósito.",

    featureFrontendTitle: "Frontend",
    featureFrontendDesc:
      "Interfaces modernas, responsivas y centradas en la experiencia de usuario.",

    featureBackendTitle: "Backend",
    featureBackendDesc:
      "Lógica robusta, APIs bien estructuradas y bases de datos confiables.",

    featureDesignTitle: "Diseño UI",
    featureDesignDesc:
      "Diseño visual limpio, coherente y alineado con la identidad del producto.",
    ...
    contactSubjectPlaceholder: "¿En qué puedo ayudarte?",
    contactMessagePlaceholder: "Cuéntame sobre tu proyecto...",
    contactSend: "Enviar mensaje",
    contactSending: "Enviando...",
    contactSuccess: "¡Mensaje enviado con éxito! Te responderé pronto.",
    ...
    contactAvailableDesc: "Actualmente aceptando nuevos proyectos y colaboraciones.",
  ...
  en: {
    ...
    featuredSubtitle:
      "I focus on building thoughtful, accessible and purposeful digital products.",
    ...
    featureBackendTitle: "Backend",
    featureBackendDesc:
      "Solid logic, well-structured APIs and reliable databases.",

    featureDesignTitle: "UI Design",
    featureDesignDesc:
      "Clean, consistent visual design aligned with product identity.",
    ...
    contactAvailableDesc: "Currently accepting new projects and collaborations.",
